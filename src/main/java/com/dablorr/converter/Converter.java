...
public class Converter {
        ...
        private final static double offlineReal = 5.68;
        private final static double offlineLibraEst = 0.77;
        private final static double offlinePesoArg = 985.25;
        private final static double offlinePesoChi = 946.89;
        private final static double offlineEuro = 0.92;
